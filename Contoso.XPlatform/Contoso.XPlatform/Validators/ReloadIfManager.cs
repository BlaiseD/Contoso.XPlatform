...
namespace Contoso.XPlatform.Validators
{
    ...
    {
        public ReloadIfManager(ICollection<IValidatable> currentProperties, List<ReloadIf<TModel>> conditions, IMapper mapper, UiNotificationService uiNotificationService)
        {
