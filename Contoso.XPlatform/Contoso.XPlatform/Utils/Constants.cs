...
{
    public struct FontAwesomeIcons
    {
        public static readonly IDictionary<string, string> Solid = new Dictionary<string, string>
        {
            { "Ad", "\uf641" },
            { "AddressBook", "\uf2b9" },
            { "AddressCard", "\uf2bb" },
    ...
    public static class FontAwesomeIconConstants
    {
        ...
        public static new string Equals = "\uf52c";
