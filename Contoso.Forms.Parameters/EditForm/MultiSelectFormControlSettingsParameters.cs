...
namespace Contoso.Forms.Parameters.EditForm
{
    ...
    {
		public MultiSelectFormControlSettingsParameters(List<string> keyFields, MultiSelectTemplateParameters multiSelectTemplate, string domElementId, string title, string placeholder, string stringFormat, string type, FieldValidationSettingsParameters validationSetting, TextFieldTemplateParameters textTemplate, DropDownTemplateParameters dropDownTemplate, string field) : base(domElementId, title, placeholder, stringFormat, type, validationSetting, textTemplate, dropDownTemplate, field)
		{
			KeyFields = keyFields;
